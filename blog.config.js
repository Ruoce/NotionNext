...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'QIN&XIN', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '两颗心，在记录', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://waterheart.love', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '恋爱日记', // 网站关键词 英文逗号隔开
